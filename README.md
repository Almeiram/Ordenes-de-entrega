...
Prueba de Rendimiento – Módulo 5.2 (Node.JS)

Codificadora: Maria Almeira
Clan: Node.JS

API REST desarrollada con Node.js, Express, TypeScript, JWT y Sequelize (PostgreSQL) para gestionar el ciclo de vida de las órdenes de entrega de la empresa FHL.
...
Una instancia de PostgreSQL (local o remota) que funcione correctamente.
